...
export default function CoachLandingScreen() {
  ...
  useEffect(() => {
    setSEO({
      ...
      description: 'See which players practice at home. Know who works hardest. Build a team where effort matters — free coaching dashboard.',
  ...
  return (
    <div className="cl-wrap">
      ...
      <section className="cl-hero">
        ...
        <h1 className="cl-title">See who works hardest. Reward the grinders.</h1>
        <p className="cl-sub">
          Know which players are practicing at home. See who puts in the work every week. Show your team that hard work matters.
        </p>
        ...
        <div style={{ maxWidth: '720px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 20 }}>
            <div>
              ...
              <button onClick={() => nav('/challenges')} style={{ display: 'block', background: 'none', border: 'none', color: 'var(--ice)', fontSize: 14, cursor: 'pointer', textAlign: 'left' }}>Challenge Tiers</button>
            </div>
            <div>
            ...
            <div>
              ...
              <button onClick={() => nav('/association-partnership')} style={{ display: 'block', background: 'none', border: 'none', color: 'var(--ice)', fontSize: 14, cursor: 'pointer', textAlign: 'left' }}>Partnerships</button>
            </div>
          </div>
        </div>
      </section>
